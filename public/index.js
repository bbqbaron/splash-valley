 ...
 */
const patch$1 = (prevStateID, stateID, patch, deltalog) => ({
    type: PATCH,
    prevStateID,
    stateID,
    patch,
...
*/
function remove$1(object, operation) {
...
function apply(object, operation) {
    ...
    switch (operation.op) {
        ...
        case 'remove': return remove$1(object, operation);
...
rfc6902.createTests = createPatch_1 = rfc6902.createPatch = applyPatch_1 = rfc6902.applyPatch = void 0;
...
var applyPatch_1 = rfc6902.applyPatch = applyPatch;
    ...
    return (stateWithTransients = null, action) => {
        ...
        switch (action.type) {
            ...
            case PATCH: {
                ...
                const patchError = applyPatch_1(newState, action.patch);
...
class _ClientImpl {
    ...
    receiveTransportData(data) {
        ...
        switch (data.type) {
            ...
            case 'patch': {
                const [, prevStateID, stateID, patch$1$1, deltalog] = data.args;
                const currentStateID = this.store.getState()._stateID;
                if (prevStateID !== currentStateID)
                    break;
                const action = patch$1(prevStateID, stateID, patch$1$1, deltalog);
                this.store.dispatch(action);
...
Object.defineProperty(cookie$1, "__esModule", {
  value: true
});
...
cookie$1.load = load;
cookie$1.loadAll = loadAll;
cookie$1.select = select;
cookie$1.save = save;
cookie$1.remove = remove;
cookie$1.setRawCookie = setRawCookie;
cookie$1.plugToRequest = plugToRequest;
...
const getFilterPlayerView = (game) => (playerID, payload) => {
    switch (payload.type) {
        case 'patch': {
            ...
            const patch = createPatch_1(prevFilteredState, filteredState);
            return {
                type: 'patch',
...
function Client(opts) {
    ...
    return _a = class WrappedBoard extends React.Component {
        ...
        _a.propTypes = {
            ...
            matchID: propTypes.exports.string,
            // The ID of the player associated with this client.
            // Only relevant in multiplayer.
            playerID: propTypes.exports.string,
            // This client's authentication credentials.
            // Only relevant in multiplayer.
            credentials: propTypes.exports.string,
            // Enable / disable the Debug UI.
            debug: propTypes.exports.any,
        },
        _a.defaultProps = {
            matchID: 'default',
            playerID: null,
...
class Lobby extends React.Component {
    ...
    componentDidMount() {
        const cookie = _default.load('lobbyState') || {};
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (prevState.phase !== this.state.phase ||
            ...
            _default.save('lobbyState', cookie, { path: '/' });
        }
...
Lobby.propTypes = {
    gameComponents: propTypes.exports.array.isRequired,
    lobbyServer: propTypes.exports.string,
    gameServer: propTypes.exports.string,
    debug: propTypes.exports.bool,
    clientFactory: propTypes.exports.func,
    refreshInterval: propTypes.exports.number,
};
Lobby.defaultProps = {
    debug: false,
...
function TicTacToeBoard(props) {
    ...
    const [selectedCell, pickCell] = react.exports.useState(null);
    const cellStyle = {
        width: '50px',
        height: '50px',
        lineHeight: '50px',
    ...
    const rows = map(y => React.createElement("tr", { key: y }, map(x => {
        ...
        return React.createElement("td", { key: x },
            React.createElement("div", { style: {
                    ...
                    if (selectedCell && selectedPiece && !alreadySelected) {
                        ...
                        if (ratioOk) {
                            moves.sendPiece(selectedCell, [x, y]);
                        }
                    }
                } }, self ?
                (React.createElement("div", { style: {
        ...
        winner ?
            ...
            :
                React.createElement(React.Fragment, null,
                    React.createElement("p", null,
                        "It's ",
                        ctx.currentPlayer == "0" ? "Black" : "White",
                        "'s turn (you're ",
                        playerName(playerID),
                        ")")),
...
const App = () => (React.createElement("div", null,
    React.createElement(Lobby, { gameServer: `http://${window.location.hostname}:8001`, lobbyServer: `http://${window.location.hostname}:8001`, gameComponents: [
            {
                game: TicTacToe,
...
var aa=react.exports,m=objectAssign,r=requireScheduler();function y(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return "Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(y(227));var ba=new Set,ca={};function da(a,b){ea(a,b);ea(a+"Capture",b);}
...
// );
reactDom.exports.render(React.createElement(React.StrictMode, null,
